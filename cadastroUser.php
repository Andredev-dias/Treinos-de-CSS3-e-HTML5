...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-nav">
    ...
    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
      <div class="navbar-nav">
        ...
        <div class="sright">
          <a  class="futin" href="perfil.php?acao=carregar&id="><img href="perfil.php" title="Visitar Perfil."  class="logado" src="img/gatinha.jpg" width="5%" height="100%" /></a>
  ...
  <div class="container">
    <div class="box">
      <h3>Cadastre-se</h3>
      <br>
      <form action="cadastroUser.php" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-row">
          <div class="col-sm-7 col-sx-12">
            ...
            <div class="form-group">
              ...
              <input type="e-mail" class="form-control" name="email" placeholder="Digite seu email">
            </div>

            <div class="form-group">
              <label for="valor">Telefone</label>
              <input type="text" id="telefone" class="form-control" name="telefone" placeholder="Seu Telefone">
            </div>

          </div>
          <div class="tamanho-img">
            <div class="col">
              <img class="border-img" src="img/user-laranja.png" width="250px" />
            </div>
          </div>
        </div>
        ...
        <div class="col-6">
              <label for="valor">Confirmar a Senha</label>
